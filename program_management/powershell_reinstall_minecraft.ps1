...
$allApps = Get-WmiObject -query "select * from CCM_Application" -namespace "root\ccm\clientsdk"| Select Name, Id, Revision, IsMachineTarget, SoftwareVersion

# Select the app
$Minecraft = $allApps | Where-Object -Property Name -Like "Minecraft Education"

# Install the latest version ###
([wmiclass]'ROOT\ccm\ClientSdk:CCM_Application').Install($($Minecraft.Id), $($Minecraft.Revision), $($Minecraft.IsMachineTarget), 0, 'Normal', $False)| Out-Null
